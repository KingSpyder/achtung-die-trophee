package flashx.textLayout.container
{
   ...
   public class ColumnState
   {
      ...
      {
         var _loc6_:Number = param3.tlf_internal::effectivePaddingTop;
         var _loc7_:Number = param3.tlf_internal::effectivePaddingBottom;
         var _loc8_:Number = param3.tlf_internal::effectivePaddingLeft;
         var _loc9_:Number = param3.tlf_internal::effectivePaddingRight;
         ...
         var _loc14_:Boolean = _loc10_.columnCount == FormatValue.AUTO && (_loc10_.columnWidth == FormatValue.AUTO || Number(_loc10_.columnWidth) == 0) || param3.rootElement.computedFormat.lineBreak == LineBreak.EXPLICIT;
      ...
      tlf_internal function computeColumns() : void
      {
         ...
         if(this._blockProgression == BlockProgression.TB)
         {
            ...
            {
               _loc6_ = isNaN(this._compositionWidth) ? 0 : this._compositionWidth - this._paddingRight - this._columnWidth;
               _loc8_ = -(this._columnWidth + this._columnGap);
               _loc11_ = this._columnWidth;
            }
