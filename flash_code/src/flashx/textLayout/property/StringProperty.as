package flashx.textLayout.property
{
   ...
   public class StringProperty extends Property
   {
      ...
      tlf_internal static function doHash(param1:String, param2:uint) : uint
      {
         ...
         {
            _loc4_ = UintProperty.tlf_internal::doHash(param1.charCodeAt(2 * _loc5_) << 16 | param1.charCodeAt(2 * _loc5_ + 1),_loc4_);
            _loc5_++;
         }
         if(_loc3_ % 2 != 0)
         {
            _loc4_ = UintProperty.tlf_internal::doHash(param1.charCodeAt(_loc3_ - 1),_loc4_);
         }
         return _loc4_;
      }
      ...
      {
         return tlf_internal::doHash(param1 as String,param2);
      }
   }
}
