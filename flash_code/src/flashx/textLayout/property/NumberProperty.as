package flashx.textLayout.property
{
   ...
   public class NumberProperty extends Property
   {
      ...
      tlf_internal static function doHash(param1:Number, param2:uint) : uint
      {
         ...
         var _loc4_:uint = UintProperty.tlf_internal::doHash(_loc3_,param2);
         if(_loc3_ != param1)
         {
            _loc5_ = uint((param1 - _loc3_) * 10000000000);
            _loc4_ = UintProperty.tlf_internal::doHash(_loc5_,_loc4_);
         }
         return _loc4_;
      }
      ...
      override public function setHelper(param1:*, param2:*) : *
      {
         ...
         var _loc3_:Number = param2 is String ? parseFloat(param2) : Number(param2);
         if(isNaN(_loc3_))
         {
      ...
      override public function hash(param1:Object, param2:uint) : uint
      {
         ...
         {
            return UintProperty.tlf_internal::doHash(tlf_internal::inheritHashValue,param2);
         }
         return NumberProperty.tlf_internal::doHash(param1 as Number,param2);
      }
   }
}
