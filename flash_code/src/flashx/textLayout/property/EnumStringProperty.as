package flashx.textLayout.property
{
   ...
   public class EnumStringProperty extends Property
   {
      ...
      public function EnumStringProperty(param1:String, param2:String, param3:Boolean, param4:String, ... rest)
      {
         ...
         this._range = tlf_internal::createRange(rest);
      }
      ...
      tlf_internal static function createRange(param1:Array) : Object
      {
         ...
         {
            _loc2_[param1[_loc3_]] = tlf_internal::nextEnumHashValue++;
            _loc3_++;
         }
         _loc2_[FormatValue.INHERIT] = tlf_internal::nextEnumHashValue++;
         return _loc2_;
      }
      ...
      {
         return UintProperty.tlf_internal::doHash(this._range[param1],param2);
      }
   }
}
