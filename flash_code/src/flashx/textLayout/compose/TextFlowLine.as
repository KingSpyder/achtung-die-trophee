package flashx.textLayout.compose
{
   ...
   public final class TextFlowLine implements IVerticalJustificationLine
   {
      ...
      private var _spaceBefore:Number = 0;
      
      private var _spaceAfter:Number = 0;
      ...
      tlf_internal static function getTextLineTypographicAscent(param1:TextLine, param2:FlowLeafElement, param3:int, param4:int, param5:ParagraphElement) : Number
      {
         ...
         while(true)
         {
            ...
            {
               _loc6_ = Math.max(_loc6_,InlineGraphicElement(param2).tlf_internal::getTypographicAscent(param1));
            }
      ...
      tlf_internal function initialize(param1:ParagraphElement, param2:Number = 0, param3:Number = 0, param4:int = 0, param5:int = 0, param6:TextLine = null) : void
      {
         ...
         if(param6)
         {
            ...
            this._unjustifiedTextWidth = param6.unjustifiedTextWidth;
            this._textWidth = param6.textWidth;
      ...
      tlf_internal function setSpaceBefore(param1:Number) : void
      {
         this._spaceBefore = param1;
      }
      ...
      tlf_internal function setSpaceAfter(param1:Number) : void
      {
         this._spaceAfter = param1;
      }
      ...
      public function get validity() : String
      {
         ...
         if(!this._released)
         {
            _loc1_ = this.tlf_internal::peekTextLine();
      ...
      {
         return this._unjustifiedTextWidth + (this._outerTargetWidth - this.tlf_internal::targetWidth);
      }
      ...
      tlf_internal function isDamaged() : Boolean
      {
         ...
         {
            _loc1_ = this.tlf_internal::peekTextLine();
            if(Boolean(_loc1_) && _loc1_.validity != TextLineValidity.VALID)
            {
               return true;
            }
         }
      ...
      tlf_internal function clearDamage() : void
      {
         ...
         this._validity = TextLineValidity.VALID;
         var _loc1_:TextLine = this.tlf_internal::peekTextLine();
         if(Boolean(_loc1_) && !this._released)
         {
      ...
      tlf_internal function damage(param1:String) : void
      {
         ...
         if(Boolean(_loc2_) && _loc2_.validity != TextLineValidity.INVALID)
         {
      ...
      public function getTextLine(param1:Boolean = false) : TextLine
      {
         ...
         if(!_loc2_ || _loc2_.validity != TextLineValidity.VALID && param1)
         {
            ...
            _loc3_ = this.paragraph.tlf_internal::getTextBlock();
            ...
            do
            {
               ...
               {
                  _loc2_ = _loc8_.tlf_internal::recreateTextLine(_loc3_,_loc4_);
                  _loc5_ = null;
               }
               _loc4_ = _loc2_;
               _loc7_++;
         ...
         if(_loc2_ != null && _loc2_.numChildren == 0 && this._adornCount > 0)
         {
            ...
            this.tlf_internal::createAdornments(_loc9_.tlf_internal::getAncestorWithContainer().computedFormat.blockProgression,_loc11_,_loc12_);
         }
         return _loc2_;
      }
      ...
      tlf_internal function recreateTextLine(param1:TextBlock, param2:TextLine) : TextLine
      {
         ...
         if(!this._released)
         {
            _loc3_ = this.tlf_internal::peekTextLine();
            if(_loc3_)
            {
               return _loc3_;
            }
      ...
      tlf_internal function createAdornments(param1:String, param2:FlowLeafElement, param3:int) : void
      {
         ...
         while(true)
         {
            ...
            this._adornCount += param2.tlf_internal::updateAdornments(this,param1);
            _loc6_ = param2.format as FlowValueHolder;
            if((_loc6_) && _loc6_.userStyles && Boolean(_loc6_.userStyles.imeStatus))
            {
               param2.tlf_internal::updateIMEAdornments(this,param1,_loc6_.userStyles.imeStatus as String);
            }
            param3 += param2.textLength;
            if(param3 >= _loc4_)
            {
      ...
      tlf_internal function getLineLeading(param1:String, param2:FlowLeafElement, param3:int) : Number
      {
         ...
         while(true)
         {
            ...
            {
               _loc6_ = TextLayoutFormat.tlf_internal::lineHeightProperty.computeActualPropertyValue(param2.computedFormat.lineHeight,param2.tlf_internal::getEffectiveFontSize());
      ...
      {
         return tlf_internal::getTextLineTypographicAscent(this.getTextLine(),param1,param2,this.absoluteStart + this.textLength,this._para);
      }
      ...
      tlf_internal function calculateSelectionBounds(param1:TextLine, param2:Array, param3:int, param4:int, param5:String, param6:Array) : void
      {
         ...
         while(_loc9_ < param4)
         {
            ...
            else if(_loc10_ is InlineGraphicElement && (_loc10_ as InlineGraphicElement).tlf_internal::float != Float.NONE)
            {
               if(_loc13_ == null)
               {
                  _loc13_ = new Array();
         ...
         if(_loc12_.length > 0 && _loc8_ + param3 == this.absoluteStart && _loc8_ + param4 == this.absoluteStart + this.textLength)
         {
            ...
            if(_loc10_.getAbsoluteStart() + _loc10_.textLength < this.absoluteStart + this.textLength && _loc16_ >= 2)
            {
               ...
               if(_loc29_ != SpanElement.tlf_internal::kParagraphTerminator.charCodeAt(0) && CharacterUtil.isWhitespace(_loc29_))
               {
                  ...
                  if(param5 != BlockProgression.RL)
                  {
                     ...
                     {
                        _loc32_.width -= _loc31_.width;
                        if(_loc7_ == Direction.RTL)
                        {
                           _loc32_.left -= _loc31_.width;
                        }
                     }
                  }
                  ...
                  {
                     _loc32_.height -= _loc31_.height;
                     if(_loc7_ == Direction.RTL)
                     {
                        _loc32_.top += _loc31_.height;
                     }
                  }
               }
            }
      ...
      tlf_internal function getRomanSelectionHeightAndVerticalAdjustment(param1:TextFlowLine, param2:TextFlowLine) : Array
      {
         ...
         {
            _loc3_ = this.height > this._textHeight ? this.height : this._textHeight;
         }
         else
         {
            ...
            {
               _loc3_ = param2.height > this._textHeight ? param2.height : this._textHeight;
      ...
      private function makeSelectionBlocks(param1:int, param2:int, param3:int, param4:String, param5:String, param6:Array) : Array
      {
         ...
         if(param3 + param1 == this.absoluteStart && param3 + param2 == this.absoluteStart + this.textLength)
         {
            ...
            _loc13_ = this._para.tlf_internal::getEffectiveJustificationRule();
            if(_loc13_ != JustificationRule.EAST_ASIAN)
            {
               if(param4 == BlockProgression.RL)
               {
                  ...
                  _loc8_.height = _loc11_.textWidth == 0 ? EMPTY_LINE_WIDTH : _loc11_.textWidth;
               }
               else
               {
                  _loc12_.y += param6[1];
                  _loc8_.height = param6[0];
                  _loc8_.width = _loc11_.textWidth == 0 ? EMPTY_LINE_WIDTH : _loc11_.textWidth;
               }
            }
            else
            {
            ...
            if(param4 == BlockProgression.RL)
            {
               _loc8_.x -= _loc11_.descent;
            }
            else
            {
               _loc8_.y += _loc11_.descent - _loc8_.height;
            }
         ...
         else
         {
            ...
            _loc18_ = _loc16_ != -1 ? this.isAtomBidi(_loc16_,param5) : false;
            _loc19_ = _loc17_ != -1 ? this.isAtomBidi(_loc17_,param5) : false;
            if(_loc18_ || _loc19_)
            {
               _loc22_ = param1;
               ...
               do
               {
                  ...
                  _loc28_ = _loc26_ != -1 ? this.isAtomBidi(_loc26_,param5) : false;
            ...
            else
            {
               ...
               if(!_loc29_ || _loc29_.tlf_internal::float == Float.NONE)
               {
      ...
      private function makeBlock(param1:int, param2:int, param3:Rectangle, param4:String, param5:String, param6:Array) : Rectangle
      {
         ...
         var _loc12_:String = this._para.tlf_internal::getEffectiveJustificationRule();
         if(param4 == BlockProgression.RL && _loc9_.getAtomTextRotation(param1) != TextRotation.ROTATE_0)
         {
            _loc8_.y = _loc10_.y;
            _loc7_.height = param1 != param2 ? _loc11_.bottom - _loc10_.top : _loc10_.height;
         ...
         {
            _loc8_.x = _loc10_.x < _loc11_.x ? _loc10_.x : _loc11_.x;
            if(param4 == BlockProgression.RL)
            {
            ...
            if(_loc12_ != JustificationRule.EAST_ASIAN)
            {
               ...
               _loc7_.width = param1 != param2 ? Math.abs(_loc11_.right - _loc10_.left) : _loc10_.width;
            }
            else
            {
         ...
         {
            _loc7_.y += _loc9_.descent - _loc7_.height;
         }
      ...
      tlf_internal function computePointSelectionRectangle(param1:int, param2:DisplayObject, param3:TextFlowLine, param4:TextFlowLine, param5:Boolean) : Rectangle
      {
         ...
         if(_loc12_ == BlockProgression.RL && _loc6_.getAtomTextRotation(_loc8_) != TextRotation.ROTATE_0)
         {
            if(!_loc17_)
            {
               setRectangleValues(_loc16_,_loc16_.x,!_loc9_ ? _loc16_.y : _loc16_.y + _loc16_.height,_loc16_.width,1);
            }
            else
            {
               setRectangleValues(_loc16_,_loc16_.x,!_loc9_ ? _loc16_.y + _loc16_.height : _loc16_.y,_loc16_.width,1);
            }
         }
         else if(!_loc17_)
         {
            setRectangleValues(_loc16_,!_loc9_ ? _loc16_.x : _loc16_.x + _loc16_.width,_loc16_.y,1,_loc16_.height);
         }
         else
         {
            setRectangleValues(_loc16_,!_loc9_ ? _loc16_.x + _loc16_.width : _loc16_.x,_loc16_.y,1,_loc16_.height);
         }
