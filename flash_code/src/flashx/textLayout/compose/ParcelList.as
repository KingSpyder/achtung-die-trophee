package flashx.textLayout.compose
{
   ...
   public class ParcelList implements IParcelList
   {
      ...
      {
         var _loc5_:Parcel = this._numParcels == 0 && Boolean(this._singleParcel) ? this._singleParcel.initialize(param1.x,param1.y,param1.width,param1.height,param2,param3,param4) : new Parcel(param1.x,param1.y,param1.width,param1.height,param2,param3,param4);
         if(this._numParcels == 0)
         {
      ...
      private function adjustForScroll(param1:ContainerController, param2:Boolean) : void
      {
         ...
         if(this._blockProgression != BlockProgression.RL)
         {
            if(param1.verticalScrollPolicy != ScrollPolicy.OFF)
            {
               ...
               if(_loc3_)
               {
                  _loc4_ = param1.tlf_internal::effectivePaddingBottom + param1.tlf_internal::effectivePaddingTop;
         ...
         else if(param1.horizontalScrollPolicy != ScrollPolicy.OFF)
         {
            ...
            if(_loc3_)
            {
               _loc5_ = param1.tlf_internal::effectivePaddingRight + param1.tlf_internal::effectivePaddingLeft;
      ...
      {
         return this._blockProgression == BlockProgression.RL ? param1.right : param1.left;
      }
      ...
      public function getComposeWidth(param1:Rectangle) : Number
      {
         ...
         return this._blockProgression == BlockProgression.RL ? param1.height : param1.width;
      }
      ...
      public function getComposeHeight(param1:Rectangle) : Number
      {
         ...
         return this._blockProgression == BlockProgression.RL ? param1.width : param1.height;
      }
