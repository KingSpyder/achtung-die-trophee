...
class TB_VJHelper implements IVerticalAdjustmentHelper
{
   ...
   {
      var _loc2_:Number = this._textFrame.compositionHeight - Number(this._textFrame.tlf_internal::effectivePaddingBottom);
   ...
   public function computeJustifyAdjustment(param1:Array, param2:int, param3:int) : void
   {
      ...
      var _loc7_:Number = this._textFrame.compositionHeight - Number(this._textFrame.tlf_internal::effectivePaddingBottom);
...
class RL_VJHelper implements IVerticalAdjustmentHelper
{
   ...
   public function computeMiddleAdjustment(param1:IVerticalJustificationLine) : void
   {
      var _loc2_:Number = this._textFrame.compositionWidth - Number(this._textFrame.tlf_internal::effectivePaddingLeft);
   ...
   public function computeJustifyAdjustment(param1:Array, param2:int, param3:int) : void
   {
      ...
      var _loc6_:IVerticalJustificationLine = param1[param2 + param3 - 1];
      var _loc7_:Number = Number(this._textFrame.tlf_internal::effectivePaddingLeft) - this._textFrame.compositionWidth;
