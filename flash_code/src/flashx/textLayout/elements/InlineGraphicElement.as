package flashx.textLayout.elements
{
   ...
   public final class InlineGraphicElement extends FlowLeafElement
   {
      ...
      public function InlineGraphicElement()
      {
         ...
         this._float = tlf_internal::floatPropertyDefinition.defaultValue;
      ...
      override tlf_internal function createContentElement() : void
      {
         ...
         _blockElement.textRotation = String(tlf_internal::rotationPropertyDefinition.defaultValue);
         _loc1_.elementHeight = this._float != Float.NONE ? 0 : this.tlf_internal::elementHeight;
         _loc1_.elementWidth = this._float != Float.NONE ? 0 : this.tlf_internal::elementWidth;
      ...
      {
         if(_blockElement == null || !this.tlf_internal::canReleaseContentElement())
         {
            return;
         }
         _text = String.fromCharCode(65007);
         super.tlf_internal::releaseContentElement();
      }
      ...
      tlf_internal function set elementWidth(param1:Number) : void
      {
         if(_blockElement)
         {
            GraphicElement(_blockElement).elementWidth = this._float != Float.NONE ? 0 : param1;
         }
         this._elementWidth = param1;
         tlf_internal::modelChanged(ModelChange.ELEMENT_MODIFIED,0,textLength,true,false);
      }
      ...
      tlf_internal function set elementHeight(param1:Number) : void
      {
         if(_blockElement)
         {
            GraphicElement(_blockElement).elementHeight = this._float != Float.NONE ? 0 : param1;
         }
      ...
      tlf_internal function set float(param1:*) : *
      {
         ...
         if(param1 === undefined)
         {
            param1 = tlf_internal::floatPropertyDefinition.defaultValue;
         }
         param1 = tlf_internal::floatPropertyDefinition.setHelper(this.tlf_internal::float,param1) as String;
         if(this._float != param1)
         {
            ...
            {
               if(_loc2_ && Boolean(_blockElement))
               {
                  _loc3_ = GraphicElement(_blockElement);
                  this.setGraphic(_loc3_.graphic);
                  this.tlf_internal::elementWidth = _loc3_.elementWidth;
                  this.tlf_internal::elementHeight = _loc3_.elementHeight;
               }
            }
            else
            {
               ...
               this.tlf_internal::elementWidth = this._elementWidth;
               this.tlf_internal::elementHeight = this._elementHeight;
            }
            tlf_internal::modelChanged(ModelChange.ELEMENT_MODIFIED,0,textLength);
         }
      }
      ...
      override tlf_internal function applyDelayedElementUpdate(param1:TextFlow, param2:Boolean, param3:Boolean) : void
      {
         ...
         if(this._graphicStatus == InlineGraphicElementStatus.LOAD_PENDING)
         {
            if(param3)
            {
               ...
               {
                  this.okToUpdateHeightAndWidth = true;
                  this._measuredWidth = _loc5_ ? _loc5_.width : 0;
                  this._measuredHeight = _loc5_ ? _loc5_.height : 0;
                  if(this.widthIsComputed())
                  {
                     if(_loc5_)
                     {
                        _loc5_.width = this.tlf_internal::elementWidth = this.computeWidth();
                     }
                     else
                     {
                  ...
                  if(this.heightIsComputed())
                  {
                     if(_loc5_)
                     {
                        _loc5_.height = this.tlf_internal::elementHeight = this.computeHeight();
                     }
                     else
                     {
      ...
      {
         if(this.tlf_internal::float != Float.NONE)
         {
            return 0;
         }
         var _loc1_:Number = super.tlf_internal::getEffectiveFontSize();
         return Math.max(_loc1_,this.tlf_internal::elementHeight);
      }
      ...
      tlf_internal function getEffectiveAscent() : Number
      {
         ...
         return this.tlf_internal::elementHeight + GraphicElement(_blockElement).elementFormat.baselineShift;
      }
      ...
      tlf_internal function getTypographicAscent(param1:TextLine) : Number
      {
         ...
         var _loc2_:Number = this.tlf_internal::elementHeight;
         ...
         return _loc6_ + _loc4_.elementFormat.baselineShift;
      }
      ...
      override public function shallowCopy(param1:int = 0, param2:int = -1) : FlowElement
      {
         ...
         _loc3_.tlf_internal::float = this.tlf_internal::float;
         return _loc3_;
      }
      ...
      override tlf_internal function calculateStrikeThrough(param1:TextLine, param2:String, param3:FontMetrics) : Number
      {
         ...
         {
            _loc4_ = _loc5_.y + this.tlf_internal::elementHeight / 2;
         }
         else
         {
            ...
            {
               _loc4_ = _loc5_.x + this.tlf_internal::elementHeight / 2;
            }
            else
            {
               _loc4_ = _loc5_.x + this.tlf_internal::elementWidth / 2;
            }
         }
      ...
      override tlf_internal function calculateUnderlineOffset(param1:Number, param2:String, param3:FontMetrics, param4:TextLine) : Number
      {
         ...
         _loc5_ += param3.underlineOffset + param3.underlineThickness / 2;
         var _loc6_:ParagraphElement = this.getParagraph();
         var _loc7_:String = _loc6_.tlf_internal::getEffectiveJustificationRule();
