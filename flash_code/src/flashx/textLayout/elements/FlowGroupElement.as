package flashx.textLayout.elements
{
   ...
   public class FlowGroupElement extends FlowElement
   {
      ...
      public function set mxmlChildren(param1:Array) : void
      {
         ...
         for each(_loc3_ in param1)
         {
            if(_loc3_ is FlowElement)
            {
               ...
               if(_loc3_ is SpanElement || _loc3_ is SubParagraphGroupElement)
               {
      ...
      override tlf_internal function createGeometry(param1:DisplayObjectContainer) : void
      {
         var _loc3_:FlowElement = null;
         var _loc2_:int = 0;
         while(_loc2_ < this._numChildren)
         {
            _loc3_ = this.getChildAt(_loc2_);
            _loc3_.tlf_internal::createGeometry(param1);
            _loc2_++;
         }
      }
      ...
      override tlf_internal function getElementByIDHelper(param1:String) : FlowElement
      {
         var _loc3_:int = 0;
         var _loc4_:FlowElement = null;
         var _loc2_:FlowElement = super.tlf_internal::getElementByIDHelper(param1);
         if(_loc2_ == null)
         {
            _loc3_ = 0;
            ...
            {
               _loc4_ = this.getChildAt(_loc3_);
               _loc2_ = _loc4_.tlf_internal::getElementByIDHelper(param1);
               if(_loc2_ != null)
               {
                  break;
               }
      ...
      override tlf_internal function getElementsByStyleNameHelper(param1:Array, param2:String) : void
      {
         var _loc4_:FlowElement = null;
         super.tlf_internal::getElementsByStyleNameHelper(param1,param2);
         var _loc3_:int = 0;
         while(_loc3_ < this._numChildren)
         {
            _loc4_ = this.getChildAt(_loc3_);
            _loc4_.tlf_internal::getElementsByStyleNameHelper(param1,param2);
            _loc3_++;
         }
      }
      ...
      {
         return !(param1 is TextFlow) && !(param1 is FlowLeafElement) && !(param1 is SubParagraphGroupElement);
      }
      ...
      public function replaceChildren(param1:int, param2:int, ... rest) : void
      {
         ...
         var _loc16_:int = 0;
         var _loc17_:uint = 0;
         var _loc18_:ContainerController = null;
         var _loc19_:TextFlow = null;
         ...
         if(param1 < param2)
         {
            ...
            while(param1 < param2)
            {
               ...
               _loc13_.tlf_internal::modelChanged(ModelChange.ELEMENT_REMOVAL,0,_loc13_.textLength);
            ...
            if(_loc12_)
            {
               ...
               while(_loc11_ < _loc15_)
               {
                  ...
                  if(_loc10_)
                  {
                     if(_loc10_.parent)
                     {
                        if(_loc10_.parent == this)
                        {
                           _loc16_ = this.getChildIndex(_loc10_);
         ...
         if(_loc7_)
         {
            ...
            while(_loc11_ < _loc7_)
            {
               ...
               ++this._numChildren;
               _loc10_.tlf_internal::setParentAndRelativeStart(this,_loc6_ + _loc17_);
               _loc17_ += _loc10_.textLength;
               param1++;
               _loc11_++;
            }
            if(_loc17_)
            {
               ...
               {
                  _loc13_ = this.getChildAt(param1++);
                  _loc13_.tlf_internal::setParentRelativeStart(_loc13_.parentRelativeStart + _loc17_);
               }
               tlf_internal::updateLengths(_loc5_,_loc17_,true);
               _loc18_ = tlf_internal::getEnclosingController(_loc6_);
               if(_loc18_)
               {
                  ContainerController(_loc18_).tlf_internal::setTextLength(_loc18_.textLength + _loc17_);
               }
            }
            _loc11_ = 0;
            while(_loc11_ < _loc7_)
            {
               _loc10_ = _loc7_ == 1 ? _loc9_ : _loc8_[_loc11_];
               _loc10_.tlf_internal::modelChanged(ModelChange.ELEMENT_ADDED,0,_loc10_.textLength);
               _loc11_++;
            }
         }
         else
         {
            ...
            if(_loc19_ != null)
            {
               ...
               {
                  _loc11_ = _loc4_;
                  if(_loc11_ >= _loc19_.textLength)
                  {
                     _loc11_--;
                  }
               }
               _loc19_.tlf_internal::damage(_loc11_,1,FlowDamageType.GEOMETRY,false);
            }
         }
      }
      ...
      override tlf_internal function applyWhiteSpaceCollapse() : void
      {
         var _loc2_:FlowElement = null;
         var _loc1_:int = 0;
         while(_loc1_ < this._numChildren)
         ...
         super.tlf_internal::applyWhiteSpaceCollapse();
      }
      ...
      override tlf_internal function appendElementsForDelayedUpdate(param1:TextFlow) : void
      {
         ...
         {
            _loc3_ = this.getChildAt(_loc2_);
            _loc3_.tlf_internal::appendElementsForDelayedUpdate(param1);
            _loc2_++;
         }
      }
   }
