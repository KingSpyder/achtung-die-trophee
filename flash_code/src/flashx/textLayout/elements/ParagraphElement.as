package flashx.textLayout.elements
{
   ...
   public final class ParagraphElement extends ParagraphFormattedElement
   {
      ...
      {
         var _loc3_:ParagraphElement = super.shallowCopy(param1,param2) as ParagraphElement;
         if(this._textBlock)
         {
            _loc3_.tlf_internal::createTextBlock();
         }
         return _loc3_;
      }
      ...
      tlf_internal function releaseTextBlock() : void
      {
         ...
         {
            _loc2_ = getChildAt(_loc1_);
            if(!_loc2_.tlf_internal::canReleaseContentElement())
            {
               return;
            }
            _loc1_++;
         ...
         if(this._textBlock.firstLine)
         {
            ...
            while(_loc3_ != null)
            {
               if(_loc3_.numChildren != 0)
               {
                  ...
                  if(_loc5_.tlf_internal::adornCount != _loc3_.numChildren)
                  {
                     return;
                  }
               }
            ...
            while(_loc4_ != null)
            {
               TextFlowLine(_loc4_.userData).tlf_internal::markReleased();
      ...
      override public function replaceChildren(param1:int, param2:int, ... rest) : void
      {
         ...
         this.tlf_internal::ensureTerminatorAfterReplace(_loc4_);
      }
      ...
      tlf_internal function ensureTerminatorAfterReplace(param1:FlowLeafElement) : void
      {
         ...
         if(param1 != _loc2_)
         {
            if(Boolean(param1) && param1 is SpanElement)
            {
               param1.tlf_internal::removeParaTerminator();
            }
            if(_loc2_)
            {
               ...
               else
               {
                  ...
                  _loc3_.tlf_internal::addParaTerminator();
               }
            }
         }
      }
      ...
      override public function set mxmlChildren(param1:Array) : void
      {
         ...
         this.tlf_internal::ensureTerminatorAfterReplace(null);
      }
            ...
            while(true)
            {
               ...
               if(_loc3_ == numChildren)
               {
                  if(_loc3_ != 0)
                  {
                     ...
                     if(_loc8_ is SubParagraphGroupElement && _loc8_.textLength == 1 && !_loc8_.tlf_internal::bindableElement)
                     {
