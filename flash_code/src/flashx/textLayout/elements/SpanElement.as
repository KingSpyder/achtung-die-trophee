package flashx.textLayout.elements
{
   ...
   public class SpanElement extends FlowLeafElement
   {
      ...
      {
         if(_blockElement == null || !tlf_internal::canReleaseContentElement())
         {
            return;
         }
      ...
      override public function get text() : String
      {
         ...
         if(Boolean(textLength) && this.tlf_internal::hasParagraphTerminator)
         {
      ...
      {
         var _loc1_:String = computedFormat.whiteSpaceCollapse;
         var _loc2_:String = this.text;
         if(!_loc1_ || _loc1_ == WhiteSpaceCollapse.COLLAPSE)
         {
            if(Boolean(tlf_internal::impliedElement) && parent != null)
            {
               if(_loc2_.search(anyPrintChar) == -1)
               {
                  parent.removeChild(this);
                  return;
               }
            }
            _loc2_ = _loc2_.replace(_newLineTabPattern," ");
            _loc2_ = _loc2_.replace(_dblSpacePattern," ");
         }
         this.replaceText(0,textLength,_loc2_.replace(_tabPlaceholderPattern,"\t"));
      ...
      public function replaceText(param1:int, param2:int, param3:String) : void
      {
         ...
         if(param2 != param1)
         {
            tlf_internal::modelChanged(ModelChange.TEXT_DELETED,param1,param2 - param1);
         }
         this.replaceTextInternal(param1,param2,param3);
         if(Boolean(param3) && Boolean(param3.length))
         {
            tlf_internal::modelChanged(ModelChange.TEXT_INSERTED,param1,param3.length);
         }
      }
      ...
      override tlf_internal function addParaTerminator() : void
      {
         ...
         tlf_internal::modelChanged(ModelChange.TEXT_INSERTED,textLength - 1,1);
      }
      
      override tlf_internal function removeParaTerminator() : void
      {
         this.replaceTextInternal(textLength - 1,textLength,"");
         tlf_internal::modelChanged(ModelChange.TEXT_DELETED,textLength > 0 ? textLength - 1 : 0,1);
      }
      ...
      override public function splitAtPosition(param1:int) : FlowElement
      {
         ...
         if(parent)
         {
            ...
            if(_blockElement)
            {
               _loc5_ = parent.tlf_internal::createContentAsGroup();
            ...
            tlf_internal::modelChanged(ModelChange.TEXT_DELETED,param1,_loc4_);
            ...
            _loc2_.tlf_internal::modelChanged(ModelChange.ELEMENT_ADDED,0,_loc2_.textLength);
         }
         else
         {
      ...
      override tlf_internal function mergeToPreviousIfPossible() : Boolean
      {
         ...
         var _loc3_:int = 0;
         if(parent && !tlf_internal::bindableElement && Boolean(tlf_internal::canReleaseContentElement()))
         {
            _loc1_ = parent.getChildIndex(this);
            if(_loc1_ != 0)
            {
               _loc2_ = parent.getChildAt(_loc1_ - 1) as SpanElement;
               if(_loc2_ != null && Boolean(_loc2_.tlf_internal::canReleaseContentElement()) && (Boolean(tlf_internal::equalStylesForMerge(_loc2_)) || this.textLength == 1 && this.tlf_internal::hasParagraphTerminator))
               {
