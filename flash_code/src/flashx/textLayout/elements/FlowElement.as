package flashx.textLayout.elements
{
   ...
   public class FlowElement implements ITextLayoutFormat
   {
      ...
      public function set userStyles(param1:Object) : void
      {
         ...
         this.tlf_internal::modelChanged(ModelChange.USER_STYLE_CHANGED,0,this.textLength,true);
      }
      ...
      {
         this.setStyle(LinkElement.tlf_internal::LINK_NORMAL_FORMAT_NAME,param1);
      }
      
      public function get linkNormalFormat() : *
      {
         return this.getStyle(LinkElement.tlf_internal::LINK_NORMAL_FORMAT_NAME);
      }
      
      public function set linkActiveFormat(param1:*) : void
      {
         this.setStyle(LinkElement.tlf_internal::LINK_ACTIVE_FORMAT_NAME,param1);
      }
      
      public function get linkActiveFormat() : *
      {
         return this.getStyle(LinkElement.tlf_internal::LINK_ACTIVE_FORMAT_NAME);
      }
      
      public function set linkHoverFormat(param1:*) : void
      {
         this.setStyle(LinkElement.tlf_internal::LINK_HOVER_FORMAT_NAME,param1);
      }
      
      public function get linkHoverFormat() : *
      {
         return this.getStyle(LinkElement.tlf_internal::LINK_HOVER_FORMAT_NAME);
      }
      ...
      tlf_internal function setPrivateStyle(param1:String, param2:*) : void
      {
         if(this.tlf_internal::getPrivateStyle(param1) != param2)
         {
            ...
            this.tlf_internal::modelChanged(ModelChange.STYLE_SELECTOR_CHANGED,0,this.textLength);
         }
      }
      ...
      {
         return this.tlf_internal::getPrivateStyle(styleNameString);
      }
      
      public function set styleName(param1:String) : void
      {
         return this.tlf_internal::setPrivateStyle(styleNameString,param1);
      }
      ...
      {
         this.tlf_internal::setPrivateStyle(impliedElementString,"true");
      }
      ...
      tlf_internal function formatChanged(param1:Boolean = true) : void
      {
         if(param1)
         {
            this.tlf_internal::modelChanged(ModelChange.TEXTLAYOUT_FORMAT_CHANGED,0,this.textLength);
         }
      ...
      public function get computedFormat() : ITextLayoutFormat
      {
         ...
         {
            this.tlf_internal::doComputeTextLayoutFormat(this.tlf_internal::formatForCascade);
         }
         return this._computedFormat;
      }
      
      tlf_internal function doComputeTextLayoutFormat(param1:ITextLayoutFormat) : void
      {
         var _loc3_:ITextLayoutFormat = null;
         var _loc4_:TextFlow = null;
         var _loc5_:ITextLayoutFormat = null;
         var _loc6_:uint = 0;
         var _loc7_:ITextLayoutFormat = null;
         var _loc2_:FlowElement = this.parent;
         if(_loc2_)
         {
            _loc3_ = _loc2_.tlf_internal::formatForCascade;
            if(TextLayoutFormat.isEqual(param1,TextLayoutFormat.tlf_internal::emptyTextLayoutFormat) && TextLayoutFormat.isEqual(_loc3_,TextLayoutFormat.tlf_internal::emptyTextLayoutFormat))
            {
               this._computedFormat = _loc2_.computedFormat;
               return;
            }
         }
         tlf_internal::_scratchTextLayoutFormat.format = param1;
         if(_loc2_)
         {
            if(_loc3_)
            {
               tlf_internal::_scratchTextLayoutFormat.concatInheritOnly(_loc3_);
            }
            while(_loc2_.parent)
            {
               _loc2_ = _loc2_.parent;
               _loc7_ = _loc2_.tlf_internal::formatForCascade;
               if(_loc7_)
               {
                  tlf_internal::_scratchTextLayoutFormat.concatInheritOnly(_loc7_);
               }
            }
            _loc4_ = _loc2_ as TextFlow;
         }
         else
         {
            _loc4_ = this as TextFlow;
         }
         if(_loc4_)
         {
            _loc5_ = _loc4_.tlf_internal::getDefaultFormat();
            _loc6_ = _loc4_.tlf_internal::getDefaultFormatHash();
         }
         this._computedFormat = TextFlow.tlf_internal::getCanonical(tlf_internal::_scratchTextLayoutFormat,_loc5_,_loc6_);
      }
      ...
      tlf_internal function getUserStyleWorker(param1:String) : *
      {
         ...
         return this.parent ? this.parent.tlf_internal::getUserStyleWorker(param1) : undefined;
      }
      ...
      tlf_internal function modelChanged(param1:String, param2:int, param3:int, param4:Boolean = true, param5:Boolean = true) : void
      {
         ...
         if(_loc6_)
         {
            _loc6_.tlf_internal::processModelChanged(param1,this,param2,param3,param4,param5);
         }
      }
      ...
      {
         if(Boolean(this._formatValueHolder) && this._formatValueHolder.whiteSpaceCollapse !== undefined)
         {
      ...
      tlf_internal function getHighestReadOnlyFlowElement() : FlowElement
      {
         ...
         if(this.tlf_internal::isReadOnlyFlowElement())
         {
            _loc1_ = this;
         }
         var _loc2_:FlowElement = this.parent;
         while(_loc2_ != null)
         {
            if(_loc2_.tlf_internal::isReadOnlyFlowElement())
            {
               _loc1_ = _loc2_;
            }
            _loc2_ = _loc2_.parent;
      ...
      public function getAbsoluteStart() : int
      {
         ...
         while(_loc2_)
         {
            _loc1_ += _loc2_.parentRelativeStart;
            _loc2_ = _loc2_.parent;
         }
         return _loc1_;
      }
      ...
      public function getElementRelativeStart(param1:FlowElement) : int
      {
         ...
         {
            _loc2_ += _loc3_.parentRelativeStart;
      ...
      {
         this.tlf_internal::setParentRelativeStart(this.parentRelativeStart + param1);
      }
      ...
      tlf_internal function updateLengths(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         this.tlf_internal::setTextLength(this.textLength + param2);
