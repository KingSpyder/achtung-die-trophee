package flashx.textLayout.elements
{
   ...
   public class Configuration implements IConfiguration
   {
      ...
      tlf_internal static const playerEnablesArgoFeatures:Boolean = tlf_internal::versionIsAtLeast(10,1) && Boolean(new TextBlock().hasOwnProperty("recreateTextLine"));
      ...
      private function initialize() : void
      {
         ...
         _loc1_ = new TextLayoutFormatValueHolder();
