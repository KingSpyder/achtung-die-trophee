package flashx.textLayout.edit
{
   ...
   public class TextScrap
   {
      ...
      {
         var _loc2_:int = int(this._beginMissingArray.length);
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
      ...
      {
         var _loc2_:int = int(this._endMissingArray.length);
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
      ...
      public function clone() : TextScrap
      {
         ...
         var _loc1_:TextFlow = this.tlf_internal::textFlow.deepCopy() as TextFlow;
         ...
         var _loc8_:FlowElement = _loc2_.tlf_internal::textFlow;
         if(_loc3_.length > 0)
         {
            _loc9_ = new Array();
            _loc9_.push(_loc8_);
            ...
            _loc2_.tlf_internal::beginMissingArray = _loc9_;
         }
         _loc5_ = _loc4_.length - 2;
         _loc8_ = _loc2_.tlf_internal::textFlow;
         if(_loc4_.length > 0)
         {
            _loc10_ = new Array();
            _loc10_.push(_loc8_);
            ...
            _loc2_.tlf_internal::endMissingArray = _loc10_;
         }
         return _loc2_;
      }
   }
