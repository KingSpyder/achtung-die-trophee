package flashx.textLayout.edit
{
   ...
   public class TextFlowEdit
   {
         ...
         while(_loc4_ < param1.numChildren)
         {
            ...
            if(_loc7_ < _loc5_.textLength && _loc8_ > 0)
            {
               if(_loc7_ <= 0 && (_loc8_ > _loc5_.textLength || _loc8_ >= _loc5_.textLength && _loc5_ is ParagraphElement))
               {
                  ...
                  _loc15_ = _loc4_ == param1.numChildren - 1 && _loc5_ is SpanElement && param1 is ParagraphElement;
      ...
      private static function putDivAtEndOfContainerAndInsertTextFlow(param1:TextFlow, param2:int, param3:FlowGroupElement, param4:Array, param5:Array, param6:Array) : int
      {
         ...
         var _loc9_:ContainerFormattedElement = TextFlowEdit.getContainer(param1.tlf_internal::findAbsoluteParagraph(_loc8_));
         var _loc10_:DivElement = TextFlowEdit.putDivAtEndOfContainer(_loc9_);
         param6.push(_loc10_);
         while(param3.numChildren > 0)
         {
            _loc7_ = param3.getChildAt(0);
            param3.replaceChildren(0,1,null);
            _loc8_ = TextFlowEdit.insertTextFlow(param1,_loc8_,_loc7_ as FlowGroupElement,param4,param5,param6);
         }
         var _loc11_:int = _loc10_.parent.getChildIndex(_loc10_);
         _loc10_.parent.replaceChildren(_loc11_,_loc11_ + 1,null);
         param6.pop();
         return _loc8_;
      }
      ...
      private static function insertTextFlow(param1:TextFlow, param2:int, param3:FlowGroupElement, param4:Array = null, param5:Array = null, param6:Array = null) : int
      {
         ...
         else
         {
            ...
            _loc11_ = param1.tlf_internal::findAbsoluteParagraph(param2);
            ...
            if(param3 is ParagraphElement)
            {
               ...
               if(!processedFirstFlowElement)
               {
                  if(_loc12_ > 0)
                  {
                     ...
                     if((Boolean(_loc17_)) && joinNextParagraph(_loc17_))
                     {
                        _loc7_--;
                     }
                  }
               ...
               if(_loc16_)
               {
                  _loc18_ = _loc15_.getTextFlow().tlf_internal::findAbsoluteParagraph(_loc7_);
      ...
      public static function replaceRange(param1:TextFlow, param2:int, param3:int, param4:TextScrap = null) : int
      {
         ...
         {
            param4 = param4.clone();
            _loc5_ = insertTextFlow(param1,param2,param4.tlf_internal::textFlow,param4.tlf_internal::beginMissingArray,param4.tlf_internal::endMissingArray);
         }
         return _loc5_;
      }
      ...
      public static function createTextScrap(param1:TextFlow, param2:int, param3:int) : TextScrap
      {
         ...
         if(_loc4_.textLength > 0)
         {
            ...
            while(Boolean(_loc8_) && Boolean(_loc7_))
            {
               if(param2 - _loc7_.getAbsoluteStart() > 0)
               {
                  _loc5_.tlf_internal::addToBeginMissing(_loc8_);
               }
            ...
            while(Boolean(_loc8_) && Boolean(_loc7_))
            {
               ...
               {
                  _loc5_.tlf_internal::addToEndMissing(_loc8_);
               }
               _loc8_ = _loc8_.parent;
               _loc7_ = _loc7_.parent;
            }
      ...
      public static function makeTCY(param1:TextFlow, param2:int, param3:int) : Boolean
      {
         ...
         var _loc5_:ParagraphElement = param1.tlf_internal::findAbsoluteParagraph(param2);
         if(!_loc5_)
         {
            return false;
         }
         while(_loc5_)
         {
            ...
            if(tlf_internal::canInsertSPBlock(param1,param2,_loc7_,TCYElement) && _loc5_.textLength > 1)
            {
               ...
               if(_loc4_)
               {
                  _loc4_ = tlf_internal::insertNewSPBlock(param1,param2,_loc7_,_loc8_,TCYElement);
               }
               else
               {
                  tlf_internal::insertNewSPBlock(param1,param2,_loc7_,_loc8_,TCYElement);
               }
            }
            else
            {
      ...
      public static function makeLink(param1:TextFlow, param2:int, param3:int, param4:String, param5:String) : Boolean
      {
         ...
         var _loc7_:ParagraphElement = param1.tlf_internal::findAbsoluteParagraph(param2);
         if(!_loc7_)
         {
            return false;
         }
         while(_loc7_)
         {
            ...
            _loc10_ = _loc9_ == _loc8_ ? _loc9_ - 1 : _loc9_;
            if(_loc10_ > param2)
            {
               ...
               if(_loc6_)
               {
                  _loc6_ = tlf_internal::insertNewSPBlock(param1,param2,_loc10_,_loc11_,LinkElement);
               }
               else
               {
                  tlf_internal::insertNewSPBlock(param1,param2,_loc10_,_loc11_,LinkElement);
               }
            }
            if(_loc8_ < param3)
            {
      ...
      tlf_internal static function subsumeElementsToSPBlock(param1:FlowGroupElement, param2:int, param3:int, param4:int, param5:SubParagraphGroupElement, param6:Class) : int
      {
         ...
         while(param3 < param4)
         {
            ...
            else
            {
               ...
               {
                  tlf_internal::flushSPBlock(_loc7_ as SubParagraphGroupElement,param6);
               }
      ...
      tlf_internal static function canInsertSPBlock(param1:TextFlow, param2:int, param3:int, param4:Class) : Boolean
      {
         ...
         var _loc5_:FlowGroupElement = param1.tlf_internal::findAbsoluteFlowGroupElement(param2);
         if(_loc5_.getParentByType(param4))
         {
            _loc5_ = _loc5_.getParentByType(param4) as FlowGroupElement;
         }
         var _loc6_:FlowGroupElement = param1.tlf_internal::findAbsoluteFlowGroupElement(param3 - 1);
      ...
      tlf_internal static function flushSPBlock(param1:SubParagraphGroupElement, param2:Class) : void
      {
         ...
         while(_loc3_ < param1.numChildren)
         {
            ...
            {
               tlf_internal::flushSPBlock(_loc4_ as SubParagraphGroupElement,param2);
               _loc3_++;
            }
            else
            {
