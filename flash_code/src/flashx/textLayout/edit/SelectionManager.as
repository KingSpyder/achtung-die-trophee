package flashx.textLayout.edit
{
   ...
   public class SelectionManager implements ISelectionManager
   {
      ...
      private static function computeSelectionIndexInContainer(param1:TextFlow, param2:ContainerController, param3:Number, param4:Number) : int
      {
         ...
         param3 -= _loc20_.x;
         param4 -= _loc20_.y;
         var _loc21_:Rectangle = new Rectangle(0,0,0,0);
         var _loc22_:TextFlowLine = TextFlowLine(_loc20_.userData);
         var _loc23_:Boolean = false;
         if(_loc10_)
         {
            _loc21_ = _loc20_.getAtomBounds(_loc20_.atomCount - 1);
         }
         else if(_loc22_.absoluteStart + _loc22_.textLength >= _loc22_.paragraph.textLength)
         {
            if(_loc20_.atomCount > 1)
            {
               _loc21_ = _loc20_.getAtomBounds(_loc20_.atomCount - 2);
            }
         }
         else
         {
            _loc31_ = _loc22_.absoluteStart + _loc22_.textLength - 1;
         ...
         if(!_loc9_)
         {
            ...
            else if(param3 > _loc21_.x + _loc21_.width)
            {
               if(_loc23_)
               {
                  return _loc22_.absoluteStart + _loc22_.textLength;
               }
               param3 = _loc21_.x + _loc21_.width;
            }
         }
         else if(param4 < 0)
         {
         ...
         else if(param4 > _loc21_.y + _loc21_.height)
         {
            if(_loc23_)
            {
               return _loc22_.absoluteStart + _loc22_.textLength;
            }
            param4 = _loc21_.y + _loc21_.height;
         }
            ...
            else
            {
               ...
               while(_loc18_ < param1.flowComposer.numControllers)
               {
                  ...
                  if(checkForDisplayed(_loc19_.container as DisplayObject))
                  {
                     ...
                     _loc21_ = isNaN(_loc19_.compositionWidth) ? _loc19_.tlf_internal::effectivePaddingLeft + _loc20_.width : _loc19_.compositionWidth;
                     _loc22_ = isNaN(_loc19_.compositionHeight) ? _loc19_.tlf_internal::effectivePaddingTop + _loc20_.height : _loc19_.compositionHeight;
                     _loc7_ = DisplayObject(param2).localToGlobal(new Point(param4,param5));
      ...
      private function selectionPoint(param1:Object, param2:InteractiveObject, param3:Number, param4:Number, param5:Boolean = false) : SelectionState
      {
         ...
         var _loc8_:FlowLeafElement = this._textFlow.findLeaf(_loc7_);
         var _loc9_:ParagraphElement = _loc8_.getParagraph();
         if(_loc7_ == _loc9_.getAbsoluteStart() + _loc9_.textLength)
         {
            _loc7_--;
         }
         if(!param5)
         ...
         if(_loc6_ == _loc7_)
         {
            if(_loc8_ is InlineGraphicElement)
            {
               _loc7_++;
            }
      ...
      private function internalSetSelection(param1:TextFlow, param2:int, param3:int, param4:ITextLayoutFormat = null) : void
      {
         ...
         {
            if(param2 >= this._textFlow.textLength)
            {
               param2 = this._textFlow.textLength - 1;
            }
            if(param3 >= this._textFlow.textLength)
            {
               param3 = this._textFlow.textLength - 1;
            }
         }
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:* = this.currentSelectionFormat.pointBlinkRate != 0;
         if(Boolean(this._textFlow.flowComposer) && (_loc1_ || !_loc1_ && this.activeMark.position != this.anchorMark.position))
         {
            ...
            {
               _loc2_ = 0;
               while(_loc2_ < this._textFlow.flowComposer.numControllers)
               {
                  this._textFlow.flowComposer.getControllerAt(_loc2_++).tlf_internal::addSelectionShapes(this.currentSelectionFormat,this.absoluteStart,this.absoluteEnd);
               }
            }
         }
      }
      ...
      private function clearSelectionShapes() : void
      {
         ...
         if(this._textFlow.flowComposer)
         {
            ...
            {
               this._textFlow.flowComposer.getControllerAt(_loc1_++).tlf_internal::clearSelectionShapes();
            }
         }
      }
      ...
      private function handleMouseEventForSelection(param1:MouseEvent, param2:Boolean) : void
      {
      ...
      public function getCommonCharacterFormat(param1:TextRange = null) : ITextLayoutFormat
      {
         ...
         var _loc3_:FlowLeafElement = _loc2_.firstLeaf;
         var _loc4_:TextLayoutFormat = new TextLayoutFormat(_loc3_.computedFormat);
         if(!this.isRangeSelection())
         {
            if(this.pointFormat)
            {
               _loc4_.apply(this.pointFormat);
            }
         }
         else
         {
            while(_loc3_ != _loc2_.lastLeaf)
            {
               _loc3_ = _loc3_.getNextLeaf();
               _loc4_.removeClashing(_loc3_.computedFormat);
            }
         }
         return Property.extractInCategory(TextLayoutFormat,TextLayoutFormat.tlf_internal::description,_loc4_,Category.CHARACTER) as ITextLayoutFormat;
      }
      
      public function getCommonParagraphFormat(param1:TextRange = null) : ITextLayoutFormat
      {
         if(!param1 && !this.hasSelection())
         {
            return null;
         ...
         var _loc2_:ElementRange = ElementRange.createElementRange(this._textFlow,param1 ? param1.absoluteStart : this.absoluteStart,param1 ? param1.absoluteEnd : this.absoluteEnd);
         var _loc3_:ParagraphElement = _loc2_.firstParagraph;
         var _loc4_:TextLayoutFormat = new TextLayoutFormat(_loc3_.computedFormat);
         while(_loc3_ != _loc2_.lastParagraph)
         {
            _loc3_ = this._textFlow.tlf_internal::findAbsoluteParagraph(_loc3_.getAbsoluteStart() + _loc3_.textLength);
            _loc4_.removeClashing(_loc3_.computedFormat);
         }
         return Property.extractInCategory(TextLayoutFormat,TextLayoutFormat.tlf_internal::description,_loc4_,Category.PARAGRAPH) as ITextLayoutFormat;
      }
      
      public function getCommonContainerFormat(param1:TextRange = null) : ITextLayoutFormat
      {
         if(!param1 && !this.hasSelection())
         {
            return null;
         }
         return Property.extractInCategory(TextLayoutFormat,TextLayoutFormat.tlf_internal::description,this.textFlow.flowComposer.getControllerAt(0).computedFormat,Category.CONTAINER) as ITextLayoutFormat;
      }
