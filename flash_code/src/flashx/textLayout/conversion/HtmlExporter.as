package flashx.textLayout.conversion
{
   ...
   internal class HtmlExporter implements ITextExporter
   {
      ...
      private function exportImage(param1:String, param2:InlineGraphicElement) : XML
      {
         ...
         if(param2.tlf_internal::float != Float.NONE)
         {
            _loc3_.@ALIGN = param2.tlf_internal::float;
         }
         return _loc3_;
      }
      ...
      private function exportParagraphFormat(param1:XML, param2:ParagraphElement) : XML
      {
         ...
         if(_loc3_.leadingModel == LeadingModel.APPROXIMATE_TEXT_FIELD)
         {
            ...
            if(_loc7_)
            {
               _loc8_ = TextLayoutFormat.tlf_internal::lineHeightProperty.computeActualPropertyValue(_loc7_.computedFormat.lineHeight,_loc7_.tlf_internal::getEffectiveFontSize());
               if(_loc8_ != 0)
               {
