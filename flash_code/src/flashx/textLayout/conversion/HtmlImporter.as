package flashx.textLayout.conversion
{
   ...
   internal class HtmlImporter extends BaseTextLayoutImporter
   {
      ...
      internal static var _fontDescription:Object = {
         "color":TextLayoutFormat.tlf_internal::colorProperty,
         "trackingRight":TextLayoutFormat.tlf_internal::trackingRightProperty,
         "fontFamily":TextLayoutFormat.tlf_internal::fontFamilyProperty
      };
      
      internal static const _fontMiscDescription:Object = {
         "size":new StringProperty("size",null,false,null),
         "kerning":new StringProperty("kerning",null,false,null)
      };
      
      internal static var _textFormatDescription:Object = {
         "paragraphStartIndent":TextLayoutFormat.tlf_internal::paragraphStartIndentProperty,
         "paragraphEndIndent":TextLayoutFormat.tlf_internal::paragraphEndIndentProperty,
         "textIndent":TextLayoutFormat.tlf_internal::textIndentProperty,
         "lineHeight":TextLayoutFormat.tlf_internal::lineHeightProperty,
         "tabStops":TextLayoutFormat.tlf_internal::tabStopsProperty
      };
      
      internal static const _textFormatMiscDescription:Object = {"blockIndent":new StringProperty("blockIndent",null,false,null)};
      
      internal static var _paragraphFormatDescription:Object = {"textAlign":TextLayoutFormat.tlf_internal::textAlignProperty};
      
      internal static const _linkHrefDescription:Object = {"href":new StringProperty("href",null,false,null)};
      
      internal static const _linkTargetDescription:Object = {"target":new StringProperty("target",null,false,null)};
      
      internal static const _imageDescription:Object = {
      ...
      internal static const _imageMiscDescription:Object = {"id":new StringProperty("id",null,false,null)};
      
      internal static const _classDescription:Object = {};
      ...
      public function HtmlImporter(param1:IConfiguration)
      {
      ...
      public static function parseSpan(param1:BaseTextLayoutImporter, param2:XML, param3:FlowGroupElement) : void
      {
         ...
         for each(_loc7_ in _loc6_)
         {
            ...
            {
               param1.tlf_internal::parseObject(_loc8_,_loc7_,param3);
            }
         }
      }
      ...
      public static function parseTextFormat(param1:BaseTextLayoutImporter, param2:XML, param3:FlowGroupElement) : void
      {
         ...
         if(_loc6_)
         {
            _loc7_ = TextLayoutFormat.tlf_internal::paragraphStartIndentProperty.setHelper(NaN,_loc6_);
            if(!isNaN(_loc7_))
            {
      ...
      override protected function importFromXML(param1:XML) : TextFlow
      {
         ...
         _baseFontSize = _loc2_.fontSize === undefined ? 12 : _loc2_.fontSize;
         ...
         _loc2_.tlf_internal::applyWhiteSpaceCollapse();
         return _loc2_;
      }
      ...
      private function createInlineGraphicFromXML(param1:XML) : InlineGraphicElement
      {
         ...
         parseAttributes(param1,_loc3_);
         var _loc4_:String = _ilgFormatImporter.getFormatValue("src");
         _loc2_.source = _loc4_;
         _loc2_.height = InlineGraphicElement.tlf_internal::heightPropertyDefinition.setHelper(_loc2_.height,_ilgFormatImporter.getFormatValue("height"));
         _loc2_.width = InlineGraphicElement.tlf_internal::heightPropertyDefinition.setHelper(_loc2_.width,_ilgFormatImporter.getFormatValue("width"));
      ...
      private function parseFontAttributes(param1:XML) : ITextLayoutFormat
      {
         ...
         if(_loc5_)
         {
            _loc7_ = TextLayoutFormat.tlf_internal::fontSizeProperty.setHelper(NaN,_loc5_);
            if(!isNaN(_loc7_))
            {
               if(_loc5_.search(/\s*(-|\+)/) != -1)
               {
                  _loc7_ += _baseFontSize;
               }
      ...
      {
         super.tlf_internal::parseObject(param1.toLowerCase(),param2,param3,param4);
      }
