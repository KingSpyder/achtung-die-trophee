package flashx.textLayout.conversion
{
   ...
   public class TextLayoutImporter extends BaseTextLayoutImporter
   {
      ...
      private static const _formatImporter:TLFormatImporter = new TLFormatImporter(TextLayoutFormatValueHolder,TextLayoutFormat.tlf_internal::description);
      ...
      public static function get defaultConfiguration() : ImportExportConfiguration
      {
         if(!_defaultConfiguration)
         {
            ...
            _defaultConfiguration.addIEInfo(LinkElement.tlf_internal::LINK_NORMAL_FORMAT_NAME,null,TextLayoutImporter.parseLinkNormalFormat,null,false);
            _defaultConfiguration.addIEInfo(LinkElement.tlf_internal::LINK_ACTIVE_FORMAT_NAME,null,TextLayoutImporter.parseLinkActiveFormat,null,false);
            _defaultConfiguration.addIEInfo(LinkElement.tlf_internal::LINK_HOVER_FORMAT_NAME,null,TextLayoutImporter.parseLinkHoverFormat,null,false);
         }
      ...
      override public function createTextFlowFromXML(param1:XML, param2:TextFlow = null) : TextFlow
      {
         ...
         _loc3_.tlf_internal::applyWhiteSpaceCollapse();
         return _loc3_;
      }
      ...
      public function createInlineGraphicFromXML(param1:XML) : InlineGraphicElement
      {
         ...
         if(_ilgFormatImporter.result)
         {
            ...
            _loc2_.height = InlineGraphicElement.tlf_internal::heightPropertyDefinition.setHelper(_loc2_.height,_ilgFormatImporter.result["height"]);
            _loc2_.width = InlineGraphicElement.tlf_internal::widthPropertyDefinition.setHelper(_loc2_.width,_ilgFormatImporter.result["width"]);
            _loc2_.tlf_internal::float = InlineGraphicElement.tlf_internal::floatPropertyDefinition.setHelper(_loc2_.tlf_internal::float,_ilgFormatImporter.result["float"]);
         }
         return _loc2_;
      }
      ...
      internal function getBoundObjNamed(param1:String, param2:Class) : Object
      {
         if(!this.bindingsArray)
         {
            this.bindingsArray = new Array();
      ...
      public function createDictionaryFromXML(param1:XML) : Dictionary
      {
         ...
         var _loc6_:Object = TextLayoutFormat.tlf_internal::description;
