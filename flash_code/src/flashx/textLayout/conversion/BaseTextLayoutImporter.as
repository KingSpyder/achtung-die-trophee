package flashx.textLayout.conversion
{
   ...
   internal class BaseTextLayoutImporter implements ITextImporter
   {
      ...
      public function BaseTextLayoutImporter(param1:IConfiguration, param2:Namespace, param3:ImportExportConfiguration)
      {
         super();
         ...
         for each(_loc5_ in param1.children())
         {
            ...
            else if(_loc5_.nodeKind() == "text")
            {
               ...
               if(!_loc7_)
               {
                  _loc8_ = new SpanElement();
                  _loc8_.text = _loc6_;
                  this.tlf_internal::addChild(param2,_loc8_);
               }
            }
         }
