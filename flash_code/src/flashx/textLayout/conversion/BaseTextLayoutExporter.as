package flashx.textLayout.conversion
{
   ...
   internal class BaseTextLayoutExporter implements ITextExporter
   {
      ...
      public static function exportTextFlow(param1:BaseTextLayoutExporter, param2:TextFlow) : XMLList
      {
         ...
         _loc3_[TextLayoutFormat.tlf_internal::whiteSpaceCollapseProperty.name] = WhiteSpaceCollapse.PRESERVE;
         return _loc3_;
      }
      ...
      protected function exportStyles(param1:XMLList, param2:Object, param3:Object = null, param4:Array = null) : void
      {
         ...
         for(_loc6_ in param2)
         {
            ...
            if(!param4 || param4.indexOf(_loc8_) == -1)
            {
               ...
               else if(_loc8_ is String || Boolean(_loc8_.hasOwnProperty("toString")))
               {
                  _loc5_.push({
                     "xmlName":_loc6_,
                     "xmlVal":_loc8_
