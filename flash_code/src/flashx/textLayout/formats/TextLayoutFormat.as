package flashx.textLayout.formats
{
   ...
   public class TextLayoutFormat implements ITextLayoutFormat
   {
      ...
      private static var _defaultFormatHash:uint;
      ...
      public static function isEqual(param1:ITextLayoutFormat, param2:ITextLayoutFormat) : Boolean
      {
         ...
         {
            return Property.equalCoreStyles(_loc3_.coreStyles,_loc4_.coreStyles,TextLayoutFormat.tlf_internal::description);
         }
      ...
      public static function get defaultFormat() : ITextLayoutFormat
      {
         if(_defaults == null)
         {
            ...
            _defaultFormatHash = _defaults.tlf_internal::hash(0);
         }
         return _defaults;
      }
      
      tlf_internal static function getDefaultFormatHash() : uint
      {
         defaultFormat;
      ...
      public function concat(param1:ITextLayoutFormat) : void
      {
         ...
         if(_loc2_)
         {
            ...
            {
               this[_loc3_] = tlf_internal::description[_loc3_].concatHelper(this[_loc3_],_loc2_.coreStyles[_loc3_]);
            }
            return;
         }
      ...
      public function concatInheritOnly(param1:ITextLayoutFormat) : void
      {
         ...
         if(_loc2_)
         {
            for(_loc3_ in _loc2_.coreStyles)
            {
               this[_loc3_] = tlf_internal::description[_loc3_].concatInheritOnlyHelper(this[_loc3_],_loc2_.coreStyles[_loc3_]);
            }
            return;
         }
      ...
      public function apply(param1:ITextLayoutFormat) : void
      {
         ...
         _loc2_ = param1.backgroundColor;
         if(_loc2_ !== undefined)
         {
            this.backgroundColor = _loc2_;
         }
         _loc2_ = param1.lineThrough;
         if(_loc2_ !== undefined)
         {
            this.lineThrough = _loc2_;
         }
         _loc2_ = param1.textAlpha;
         if(_loc2_ !== undefined)
         {
            this.textAlpha = _loc2_;
         }
         _loc2_ = param1.backgroundAlpha;
         if(_loc2_ !== undefined)
         {
         ...
         _loc2_ = param1.baselineShift;
         if(_loc2_ !== undefined)
         {
            this.baselineShift = _loc2_;
         }
         _loc2_ = param1.trackingLeft;
         if(_loc2_ !== undefined)
         {
            this.trackingLeft = _loc2_;
         }
         _loc2_ = param1.trackingRight;
         if(_loc2_ !== undefined)
         {
            this.trackingRight = _loc2_;
         }
         _loc2_ = param1.lineHeight;
         if(_loc2_ !== undefined)
         {
            this.lineHeight = _loc2_;
         }
         _loc2_ = param1.breakOpportunity;
         if(_loc2_ !== undefined)
         {
            this.breakOpportunity = _loc2_;
         }
         _loc2_ = param1.digitCase;
         if(_loc2_ !== undefined)
         {
            this.digitCase = _loc2_;
         }
         _loc2_ = param1.digitWidth;
         if(_loc2_ !== undefined)
         {
            this.digitWidth = _loc2_;
         }
         _loc2_ = param1.dominantBaseline;
         if(_loc2_ !== undefined)
         {
            this.dominantBaseline = _loc2_;
         }
         _loc2_ = param1.kerning;
         if(_loc2_ !== undefined)
         {
            this.kerning = _loc2_;
         }
         _loc2_ = param1.ligatureLevel;
         if(_loc2_ !== undefined)
         {
            this.ligatureLevel = _loc2_;
         }
         _loc2_ = param1.alignmentBaseline;
         if(_loc2_ !== undefined)
         {
            this.alignmentBaseline = _loc2_;
         }
         _loc2_ = param1.locale;
         if(_loc2_ !== undefined)
         {
            this.locale = _loc2_;
         }
         _loc2_ = param1.typographicCase;
         if(_loc2_ !== undefined)
         {
         ...
         _loc2_ = param1.textDecoration;
         if(_loc2_ !== undefined)
         {
            this.textDecoration = _loc2_;
         }
         _loc2_ = param1.fontWeight;
         if(_loc2_ !== undefined)
         {
            this.fontWeight = _loc2_;
         }
         _loc2_ = param1.fontStyle;
         if(_loc2_ !== undefined)
         {
            this.fontStyle = _loc2_;
         }
         _loc2_ = param1.whiteSpaceCollapse;
         if(_loc2_ !== undefined)
         {
            this.whiteSpaceCollapse = _loc2_;
         }
         _loc2_ = param1.renderingMode;
         if(_loc2_ !== undefined)
         {
            this.renderingMode = _loc2_;
         }
         _loc2_ = param1.cffHinting;
         if(_loc2_ !== undefined)
         {
            this.cffHinting = _loc2_;
         }
         _loc2_ = param1.fontLookup;
         if(_loc2_ !== undefined)
         {
            this.fontLookup = _loc2_;
         }
         _loc2_ = param1.textRotation;
         if(_loc2_ !== undefined)
         {
            this.textRotation = _loc2_;
         }
         _loc2_ = param1.textIndent;
         if(_loc2_ !== undefined)
         {
            this.textIndent = _loc2_;
         }
         _loc2_ = param1.paragraphStartIndent;
         if(_loc2_ !== undefined)
         {
            this.paragraphStartIndent = _loc2_;
         }
         _loc2_ = param1.paragraphEndIndent;
         if(_loc2_ !== undefined)
         {
            this.paragraphEndIndent = _loc2_;
         }
         _loc2_ = param1.paragraphSpaceBefore;
         if(_loc2_ !== undefined)
         {
            this.paragraphSpaceBefore = _loc2_;
         }
         _loc2_ = param1.paragraphSpaceAfter;
         if(_loc2_ !== undefined)
         {
            this.paragraphSpaceAfter = _loc2_;
         }
         _loc2_ = param1.textAlign;
         if(_loc2_ !== undefined)
         {
            this.textAlign = _loc2_;
         }
         _loc2_ = param1.textAlignLast;
         if(_loc2_ !== undefined)
         {
            this.textAlignLast = _loc2_;
         }
         _loc2_ = param1.textJustify;
         if(_loc2_ !== undefined)
         {
            this.textJustify = _loc2_;
         }
         _loc2_ = param1.justificationRule;
         if(_loc2_ !== undefined)
         {
            this.justificationRule = _loc2_;
         }
         _loc2_ = param1.justificationStyle;
         if(_loc2_ !== undefined)
         {
         ...
         _loc2_ = param1.tabStops;
         if(_loc2_ !== undefined)
         {
            this.tabStops = _loc2_;
         }
         _loc2_ = param1.leadingModel;
         if(_loc2_ !== undefined)
         {
            this.leadingModel = _loc2_;
         }
         _loc2_ = param1.columnGap;
         if(_loc2_ !== undefined)
         {
            this.columnGap = _loc2_;
         }
         _loc2_ = param1.paddingLeft;
         if(_loc2_ !== undefined)
         {
            this.paddingLeft = _loc2_;
         }
         _loc2_ = param1.paddingTop;
         if(_loc2_ !== undefined)
         {
            this.paddingTop = _loc2_;
         }
         _loc2_ = param1.paddingRight;
         if(_loc2_ !== undefined)
         {
            this.paddingRight = _loc2_;
         }
         _loc2_ = param1.paddingBottom;
         if(_loc2_ !== undefined)
         {
         ...
         _loc2_ = param1.columnWidth;
         if(_loc2_ !== undefined)
         {
            this.columnWidth = _loc2_;
         }
         _loc2_ = param1.firstBaselineOffset;
         if(_loc2_ !== undefined)
         {
            this.firstBaselineOffset = _loc2_;
         }
         _loc2_ = param1.verticalAlign;
         if(_loc2_ !== undefined)
         {
            this.verticalAlign = _loc2_;
         }
         _loc2_ = param1.blockProgression;
         if(_loc2_ !== undefined)
         {
            this.blockProgression = _loc2_;
         }
         _loc2_ = param1.lineBreak;
         if(_loc2_ !== undefined)
         {
      ...
      public function removeMatching(param1:ITextLayoutFormat) : void
      {
         ...
         if(_loc2_)
         {
            for(_loc3_ in _loc2_.coreStyles)
            {
               if(tlf_internal::description[_loc3_].equalHelper(this[_loc3_],_loc2_.coreStyles[_loc3_]))
               {
      ...
      tlf_internal function hash(param1:uint) : uint
      {
         var _loc2_:uint = param1;
         if(this._color)
         {
            _loc2_ = _colorProperty.hash(this._color,_loc2_);
         }
         if(this._backgroundColor)
         {
            _loc2_ = _backgroundColorProperty.hash(this._backgroundColor,_loc2_);
         }
         if(this._lineThrough)
         {
            _loc2_ = _lineThroughProperty.hash(this._lineThrough,_loc2_);
         }
         if(this._textAlpha)
         {
            _loc2_ = _textAlphaProperty.hash(this._textAlpha,_loc2_);
         }
         if(this._backgroundAlpha)
         {
            _loc2_ = _backgroundAlphaProperty.hash(this._backgroundAlpha,_loc2_);
         }
         if(this._fontSize)
         {
            _loc2_ = _fontSizeProperty.hash(this._fontSize,_loc2_);
         }
         if(this._baselineShift)
         {
            _loc2_ = _baselineShiftProperty.hash(this._baselineShift,_loc2_);
         }
         if(this._trackingLeft)
         {
            _loc2_ = _trackingLeftProperty.hash(this._trackingLeft,_loc2_);
         }
         if(this._trackingRight)
         {
            _loc2_ = _trackingRightProperty.hash(this._trackingRight,_loc2_);
         }
         if(this._lineHeight)
         {
            _loc2_ = _lineHeightProperty.hash(this._lineHeight,_loc2_);
         }
         if(this._breakOpportunity)
         {
            _loc2_ = _breakOpportunityProperty.hash(this._breakOpportunity,_loc2_);
         }
         if(this._digitCase)
         {
            _loc2_ = _digitCaseProperty.hash(this._digitCase,_loc2_);
         }
         if(this._digitWidth)
         {
            _loc2_ = _digitWidthProperty.hash(this._digitWidth,_loc2_);
         }
         if(this._dominantBaseline)
         {
            _loc2_ = _dominantBaselineProperty.hash(this._dominantBaseline,_loc2_);
         }
         if(this._kerning)
         {
            _loc2_ = _kerningProperty.hash(this._kerning,_loc2_);
         }
         if(this._ligatureLevel)
         {
            _loc2_ = _ligatureLevelProperty.hash(this._ligatureLevel,_loc2_);
         }
         if(this._alignmentBaseline)
         {
            _loc2_ = _alignmentBaselineProperty.hash(this._alignmentBaseline,_loc2_);
         }
         if(this._locale)
         {
            _loc2_ = _localeProperty.hash(this._locale,_loc2_);
         }
         if(this._typographicCase)
         {
            _loc2_ = _typographicCaseProperty.hash(this._typographicCase,_loc2_);
         }
         if(this._fontFamily)
         {
            _loc2_ = _fontFamilyProperty.hash(this._fontFamily,_loc2_);
         }
         if(this._textDecoration)
         {
            _loc2_ = _textDecorationProperty.hash(this._textDecoration,_loc2_);
         }
         if(this._fontWeight)
         {
            _loc2_ = _fontWeightProperty.hash(this._fontWeight,_loc2_);
         }
         if(this._fontStyle)
         {
            _loc2_ = _fontStyleProperty.hash(this._fontStyle,_loc2_);
         }
         if(this._whiteSpaceCollapse)
         {
            _loc2_ = _whiteSpaceCollapseProperty.hash(this._whiteSpaceCollapse,_loc2_);
         }
         if(this._renderingMode)
         {
            _loc2_ = _renderingModeProperty.hash(this._renderingMode,_loc2_);
         }
         if(this._cffHinting)
         {
            _loc2_ = _cffHintingProperty.hash(this._cffHinting,_loc2_);
         }
         if(this._fontLookup)
         {
            _loc2_ = _fontLookupProperty.hash(this._fontLookup,_loc2_);
         }
         if(this._textRotation)
         {
            _loc2_ = _textRotationProperty.hash(this._textRotation,_loc2_);
         }
         if(this._textIndent)
         {
            _loc2_ = _textIndentProperty.hash(this._textIndent,_loc2_);
         }
         if(this._paragraphStartIndent)
         {
            _loc2_ = _paragraphStartIndentProperty.hash(this._paragraphStartIndent,_loc2_);
         }
         if(this._paragraphEndIndent)
         {
            _loc2_ = _paragraphEndIndentProperty.hash(this._paragraphEndIndent,_loc2_);
         }
         if(this._paragraphSpaceBefore)
         {
            _loc2_ = _paragraphSpaceBeforeProperty.hash(this._paragraphSpaceBefore,_loc2_);
         }
         if(this._paragraphSpaceAfter)
         {
            _loc2_ = _paragraphSpaceAfterProperty.hash(this._paragraphSpaceAfter,_loc2_);
         }
         if(this._textAlign)
         {
            _loc2_ = _textAlignProperty.hash(this._textAlign,_loc2_);
         }
         if(this._textAlignLast)
         {
            _loc2_ = _textAlignLastProperty.hash(this._textAlignLast,_loc2_);
         }
         if(this._textJustify)
         {
            _loc2_ = _textJustifyProperty.hash(this._textJustify,_loc2_);
         }
         if(this._justificationRule)
         {
            _loc2_ = _justificationRuleProperty.hash(this._justificationRule,_loc2_);
         }
         if(this._justificationStyle)
         {
            _loc2_ = _justificationStyleProperty.hash(this._justificationStyle,_loc2_);
         }
         if(this._direction)
         {
            _loc2_ = _directionProperty.hash(this._direction,_loc2_);
         }
         if(this._tabStops)
         {
            _loc2_ = _tabStopsProperty.hash(this._tabStops,_loc2_);
         }
         if(this._leadingModel)
         {
            _loc2_ = _leadingModelProperty.hash(this._leadingModel,_loc2_);
         }
         if(this._columnGap)
         {
            _loc2_ = _columnGapProperty.hash(this._columnGap,_loc2_);
         }
         if(this._paddingLeft)
         {
            _loc2_ = _paddingLeftProperty.hash(this._paddingLeft,_loc2_);
         }
         if(this._paddingTop)
         {
            _loc2_ = _paddingTopProperty.hash(this._paddingTop,_loc2_);
         }
         if(this._paddingRight)
         {
            _loc2_ = _paddingRightProperty.hash(this._paddingRight,_loc2_);
         }
         if(this._paddingBottom)
         {
            _loc2_ = _paddingBottomProperty.hash(this._paddingBottom,_loc2_);
         }
         if(this._columnCount)
         {
            _loc2_ = _columnCountProperty.hash(this._columnCount,_loc2_);
         }
         if(this._columnWidth)
         {
            _loc2_ = _columnWidthProperty.hash(this._columnWidth,_loc2_);
         }
         if(this._firstBaselineOffset)
         {
            _loc2_ = _firstBaselineOffsetProperty.hash(this._firstBaselineOffset,_loc2_);
         }
         if(this._verticalAlign)
         {
            _loc2_ = _verticalAlignProperty.hash(this._verticalAlign,_loc2_);
         }
         if(this._blockProgression)
         {
            _loc2_ = _blockProgressionProperty.hash(this._blockProgression,_loc2_);
         }
         if(this._lineBreak)
         {
            _loc2_ = _lineBreakProperty.hash(this._lineBreak,_loc2_);
         }
         return _loc2_;
      }
   }
