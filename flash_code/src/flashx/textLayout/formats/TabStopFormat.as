package flashx.textLayout.formats
{
   ...
   public class TabStopFormat implements ITabStopFormat
   {
      ...
      tlf_internal function hash(param1:uint) : uint
      {
         ...
         if(this._position)
         {
            _loc2_ = _positionProperty.hash(this._position,_loc2_);
         }
         if(this._alignment)
         {
            _loc2_ = _alignmentProperty.hash(this._alignment,_loc2_);
         }
         if(this._decimalAlignmentToken)
         {
            _loc2_ = _decimalAlignmentTokenProperty.hash(this._decimalAlignmentToken,_loc2_);
         }
         return _loc2_;
      }
   }
