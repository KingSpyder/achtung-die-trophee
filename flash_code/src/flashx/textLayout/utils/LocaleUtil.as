...
class LocaleSettings
{
   ...
   {
      var _loc2_:Object = TextLayoutFormat.tlf_internal::justificationRuleProperty.setHelper(this._justificationRule,param1);
   ...
   {
      var _loc2_:Object = TextLayoutFormat.tlf_internal::justificationStyleProperty.setHelper(this._justificationStyle,param1);
   ...
   {
      var _loc2_:Object = TextLayoutFormat.tlf_internal::leadingModelProperty.setHelper(this._leadingModel,param1);
   ...
   {
      var _loc2_:Object = TextLayoutFormat.tlf_internal::dominantBaselineProperty.setHelper(this._dominantBaseline,param1);
